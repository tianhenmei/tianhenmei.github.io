...
var imgArray = [
	...
	loadingHost+"images/icon.png?v=3",
	...
	loadingHost+"images/page0-start-btn-02.png",
	...
	loadingHost+"images/page2-options.png?v=3",
	loadingHost+"images/page2-options-active.png",
	loadingHost+"images/page2-title.png",
	loadingHost+"images/page2-detail.png?v=2",
	...
	loadingHost+"images/page3-options-active.png?v=2",
	loadingHost+"images/page3-detail.png?v=2",
	...
	loadingHost+"images/page4-detail.png?v=2",
	...
	loadingHost+"images/page5-icon.png?v=3",
	// loadingHost+"images/page5-option-active.png",
	loadingHost+"images/page5-detail.png?v=2",
	...
	loadingHost+"images/page6-option-active.png",
	loadingHost+"images/page6-detail.png",
	loadingHost+"images/page6-icon.png",
	loadingHost+"images/page6-start-btn-02.png",
