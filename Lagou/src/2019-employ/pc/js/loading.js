...
// JavaScript Document
var loadingHost = '';
// var loadingHost = 'https://www.lgstatic.com/activity-rsrc/dist/2019-employ/h5/';
var imgArray = [
	// loadingHost+"images/loading-bg.png",
	loadingHost+"images/b-arrow.png",
	loadingHost+"images/B-bg.png",
	loadingHost+"images/B-center-bg.png",
	loadingHost+"images/B-title",
	loadingHost+"images/banner-center.png",

	loadingHost+"images/banner-title.png",
	loadingHost+"images/bg.png",
	loadingHost+"images/bottom-logo.png",
	loadingHost+"images/C-bg.png",
	loadingHost+"images/C-title.png",
	loadingHost+"images/corperate-content.png",
	loadingHost+"images/D-bg.png",
	loadingHost+"images/D-title.png",
	loadingHost+"images/employer-bg.png",
	loadingHost+"images/employer-title.png",
	loadingHost+"images/green-shadow-02.png",

	loadingHost+"images/green-shadow-03.png",
	loadingHost+"images/green-shadow-04.png",
	loadingHost+"images/green-shadow.png",
	loadingHost+"images/icon-address.png",
	loadingHost+"images/icon-arrow.png",
	loadingHost+"images/icon-more-02.png",
	loadingHost+"images/icon-more.png",
	loadingHost+"images/partner-title.png"
	// loadingHost+"images/tab-active-bg.png",
];
