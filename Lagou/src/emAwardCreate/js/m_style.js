...
function toComCover(swiper, comid) {
    ...
    ajax(_url, _data, 'get', function(data) {
        ...
        alert('抱歉该公司不存在，将为你跳转生成页面，请重新输入公司查找～');
        window.location.href = 'https://activity.lagou.com/activity/dist/emAwardCreate/m_index.html';
    });
}
