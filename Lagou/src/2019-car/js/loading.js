...
var imgArray = [
	...
	loadingHost+"images/page0-anwser01.png",
	loadingHost+"images/page0-anwser02.png",
	loadingHost+"images/page0-anwser03.png",
	loadingHost+"images/page0-anwser04.png",
	loadingHost+"images/page0-anwser05.png",
	loadingHost+"images/page0-l01-text.png",
	loadingHost+"images/page0-l01.png",
	loadingHost+"images/page0-l02-person.png",
	loadingHost+"images/page0-l02-text.png",
	loadingHost+"images/page0-l02.png",
	loadingHost+"images/page0-l03-text.png",
	loadingHost+"images/page0-l03.png",
	loadingHost+"images/page0-l04-text.png",
	loadingHost+"images/page0-l04.png",
	loadingHost+"images/page0-l05-bg.png",
	loadingHost+"images/page0-l05-text01.png",
	loadingHost+"images/page0-l05-text02.png",
	loadingHost+"images/page0-l05.png",
	loadingHost+"images/page0-l06-text.png",
	loadingHost+"images/page0-l06.png",
	loadingHost+"images/page0-l07.png",
	loadingHost+"images/page0-l08-text.png",
	loadingHost+"images/page0-l08.png",
	loadingHost+"images/page0-l09.png",
	loadingHost+"images/page0-l10-text.png",
	loadingHost+"images/page0-l10.png",
	loadingHost+"images/page0-l11-dialog.png",
	loadingHost+"images/page0-l11-light.png",
	loadingHost+"images/page0-l11-text.png",
	loadingHost+"images/page0-l11.png",
	loadingHost+"images/page0-l12-question.png",
	loadingHost+"images/page0-l12-text.png",
	loadingHost+"images/page0-l12.png",
	loadingHost+"images/page0-question02.png",
];
