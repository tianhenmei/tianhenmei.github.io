...
(function(f){f.Callbacks=function(g){g=f.extend({},g);var c,n,l,p,h,k,b=[],a=!g.once&&[],q=function(e){c=g.memory&&e;n=!0;k=p||0;p=0;h=b.length;for(l=!0;b&&k<h;++k)if(!1===b[k].apply(e[0],e[1])&&g.stopOnFalse){c=!1;break}l=!1;b&&(a?a.length&&q(a.shift()):c?b.length=0:m.disable())},m={add:function(){if(b){var e=b.length,d=function(e){f.each(e,function(e,a){"function"===typeof a?g.unique&&m.has(a)||b.push(a):a&&a.length&&"string"!==typeof a&&d(a)})};d(arguments);l?h=b.length:c&&(p=e,q(c))}return this},
remove:function(){b&&f.each(arguments,function(a,d){for(var c;-1<(c=f.inArray(d,b,c));)b.splice(c,1),l&&(c<=h&&--h,c<=k&&--k)});return this},has:function(a){return!!(b&&(a?-1<f.inArray(a,b):b.length))},empty:function(){h=b.length=0;return this},disable:function(){b=a=c=void 0;return this},disabled:function(){return!b},lock:function(){a=void 0;c||m.disable();return this},locked:function(){return!a},fireWith:function(c,d){!b||n&&!a||(d=d||[],d=[c,d.slice?d.slice():d],l?a.push(d):q(d));return this},
