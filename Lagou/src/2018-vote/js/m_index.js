    ...
    data:{
        ...
        page0:{
            ...
            in:{
                ...
                text1:'littleZoomIn duration2-0 delay0-5',
                text2:'littleZoomIn duration2-0 delay1-5',
                text3:'littleZoomIn duration2-0 delay2-5',
                text31:'littleZoomIn duration2-0 delay3-5',
                text4:'littleZoomIn duration2-0 delay4-5',
                text5:'littleZoomIn duration2-0 delay5-5',
                text6:'littleZoomIn duration2-0 delay6-5',
                text61:'littleZoomIn duration2-0 delay7-5',
                text62:'littleZoomIn duration2-0 delay8-5',
                text7:'littleZoomIn duration2-0 delay9-5',
                text8:'littleZoomIn duration2-0 delay10-5',
                text9:'littleZoomIn duration2-0 delay11-5',
                text10:'littleZoomIn duration2-0 delay12-5',
                text11:'littleZoomIn duration2-0 delay12-5',
            ...
            dir:[
                {
                    ...
                    detail:[
                        {
                            ...
                            title:'挖掘',
                            info:'通过专业评审模型，<br/>挖掘并盘点互联网各行业各领域Top企业；',
                    ...
                    detail:[
                        /*{
                            ...
                            title:'入围方式',
                            height:setRem(33 * 2 + 26 + 2 + 45),
                            info:'由大众评审投票决定，排名前150位企业<br/>进入最终评审；',
                    ...
                    detail:[
                        {
                            ...
                            height:setRem(33 * 3 + 26 + 2 + 45),
                            title:'入围福利',
                            info:'a. 点亮企业主页“入围TOP雇主”图标10天；<br/>'+
                                'b. 投票排名前500企业获得拉勾独家出品的<br/>'+
                                '<span class="space"></span><span class="green">《2018互联网行业白皮书》电子版一份；</span>',
        ...
        loadingArray:[
            ...
            "images/create-share09.png",  // 15
            "images/create-share10.png"  // 16
        ],
        shareArr:[{
            w:543,
            h:237
    ...
    methods:{
        ...
        initImageLoading:function(){
            ...
            if(this.loaded == this.loadingArray.length){
                ...
                this.ctx.drawImage(this.loadedImgs[1],504,58);
                this.ctx.drawImage(this.loadedImgs[2],0,1137);
                this.ctx.drawImage(this.loadedImgs[3],64,945);
                this.ctx.drawImage(this.loadedImgs[4],71,168);
                this.ctx.drawImage(this.loadedImgs[5],70,460);
                this.ctx.drawImage(this.loadedImgs[6],70,805);
        ...
        drawAllInformation:function(){
            ...
            this.ctx.drawImage(this.loadedImgs[7+index],70,518);
        ...
        drawErcode:function(img){
            this.ctx.drawImage(img,0,0,img.width,img.height,601,1171,104,104);
        },
        ...
        drawCompanyInfo:function(){
            ...
            this.ctx.fillText(this.mycompany.companyName || this.mycompany.companyShortName || this.mycompany.shortName,69,339+30)
        },
