...
var imgArray = [
	...
	loadingHost+"images/page3-card-inner-border.png",
	loadingHost+"images/page3-card-inner-light.png",
	loadingHost+"images/page3-card-inner-x-bg.png",
	loadingHost+"images/page3-card-inner-x-border.png",
	loadingHost+"images/page3-card-inner-x-light.png",
	loadingHost+"images/page3-card-inner-x.png",
	loadingHost+"images/page3-card-inner.png",
